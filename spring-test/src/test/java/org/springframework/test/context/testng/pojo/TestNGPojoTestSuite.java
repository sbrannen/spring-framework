...
/**
 * JUnit Platform based test suite for POJO tests written in TestNG that involve
...
@SelectPackages("org.springframework.test.context.testng.pojo")
@IncludeClassNamePatterns(".*Tests?$")
class TestNGPojoTestSuite {
}
