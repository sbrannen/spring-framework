...
// @ContextConfiguration(locations = "model/applicationContext-concurrency-simple.xml", loader = MockContextLoader.class)
...
public class SpringJUnit4ClassRunnerEnvironmentAssumptionsTest {
	...
	private final String threadInfo = getThreadInfo();
