...
/**
 * This class is a copy of {@link ClassLevelDisabledSpringRunnerTests} that
 ...
 */
@TestExecutionListeners(ClassLevelDisabledSpringRuleTests.CustomTestExecutionListener.class)
@IfProfileValue(name = "ClassLevelDisabledSpringRuleTests.profile_value.name", value = "enigmaX")
public class ClassLevelDisabledSpringRuleTests {
