...
/**
 * Verifies that {@code @SpringExtensionConfig(useTestClassScopedExtensionContext = false)}
 * overrides {@link SpringExtension#EXTENSION_CONTEXT_SCOPE_PROPERTY_NAME}{@code =test_class}.
 *
 * @author Sam Brannen
 * @since 7.0.7
...
class SpringExtensionConfigOverridesGlobalPropertyNestedIntegrationTests {
