 ...
 * customize the behavior of the {@link SpringExtension}.
 *
 * <p>This annotation should be applied to top-level test classes that use the
 * {@code SpringExtension}. If you wish to configure the {@code SpringExtension}
 * within a {@link org.junit.jupiter.api.Nested @Nested} test class hierarchy, this
 * annotation should be applied to the top-level (outer most) test class of the
 * {@code @Nested} hierarchy.
 *
 * <p>Note that
 * {@link org.springframework.test.context.NestedTestConfiguration @NestedTestConfiguration}
 * does not apply to this annotation: {@code @SpringExtensionConfig} will always be
 * detected within a {@code @Nested} hierarchy, effectively disregarding any
 * {@code @NestedTestConfiguration(OVERRIDE)} declarations.
 *
 * @author Sam Brannen
 * @since 7.0
...
public @interface SpringExtensionConfig {
	 ...
	 * unless you are setting this attribute to {@code true}.
	 *
