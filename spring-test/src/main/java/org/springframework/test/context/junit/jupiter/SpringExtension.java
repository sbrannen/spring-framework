 ...
 * configured} to use a test-method scoped {@link ExtensionContext}, which enables
 * consistent dependency injection into fields and constructors from the
 * {@link ApplicationContext} for the currently executing test method in a
 ...
 * a test-scoped extension context &mdash; or if a developer wishes to switch to
 * the previous semantics &mdash; the extension context can be changed to a
 * test-class scoped extension context by annotating a top-level test class with
