...
public interface TestContext extends AttributeAccessor, Serializable {
	...
	/**
	 * Set the {@link ExecutableInvoker} to use.
	 * @since 6.1
	 */
	default void setExecutableInvoker(ExecutableInvoker executableInvoker) {
		/* no-op */
	}

	/**
	 * Get the {@link ExecutableInvoker} to use.
	 * <p>By default, this method returns {@link ExecutableInvoker#DEFAULT}.
	 * @since 6.1
	 */
	default ExecutableInvoker getExecutableInvoker() {
		return ExecutableInvoker.DEFAULT;
	}
