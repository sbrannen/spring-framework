...
public class DependencyInjectionTestExecutionListener extends AbstractTestExecutionListener {
	...
	public void prepareTestInstance(TestContext testContext) throws Exception {
		...
		if (runningInAotMode(testContext)) {
	...
	/**
	 * Determine if we are running in AOT mode for the supplied {@link TestContext}.
	 */
	private boolean runningInAotMode(TestContext testContext) {
		return (this.aotTestMappings != null &&
				this.aotTestMappings.isSupportedTestClass(testContext.getTestClass()));
	}
