native-image \
	...
	--initialize-at-build-time=org.apache.logging.log4j.spi.ExtendedLogger \
	...
	--initialize-at-run-time=org.apache.logging.log4j.core.async.AsyncLoggerConfigDisruptor \
