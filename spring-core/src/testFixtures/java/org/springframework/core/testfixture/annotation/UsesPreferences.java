...
/**
 * Indicates that the annotated test class or test method uses {@link java.util.prefs.Preferences}.
 *
...
@Inherited
@Documented
@DisabledInGraalVmNativeImage("uses java.util.prefs.Preferences")
@Tag("uses-preferences")
