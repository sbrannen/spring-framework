...
public final class ClassNameGenerator {
	...
	/**
	 * Create a new {@link ClassNameGenerator} instance for the specified default
	 * target class, keeping track of all the class names generated by this instance.
	 * @param defaultTarget the default target class to use
	 * @return a new instance for the specified default target class
	 */
	ClassNameGenerator withTargetClass(Class<?> defaultTarget) {
