...
public interface ConfigurablePropertyAccessor extends PropertyAccessor, PropertyEditorRegistry, TypeConverter {
	 ...
	 * the platform.
	 * @since 7.1
	 * @see #setMaximumNestedPathDepth(int)
	 */
	 ...
	 * @param maximumNestedPathDepth the maximum nesting depth; must not be negative
	 * @since 7.1
	 */
	void setMaximumNestedPathDepth(int maximumNestedPathDepth);

	/**
	 * Return the maximum nesting depth permitted for a nested property path.
	 * @since 7.1
	 */
	int getMaximumNestedPathDepth();
